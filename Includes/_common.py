...
course_config = CourseConfig(course_code = "delp",
                             ...
                             supported_dbrs = ["11.3.x-scala2.12", "11.3.x-photon-scala2.12", "11.3.x-cpu-ml-scala2.12", "12.1.x-photon-scala2.12"],
                             expected_dbrs = "11.3.x-scala2.12, 11.3.x-photon-scala2.12, 11.3.x-cpu-ml-scala2.12, 12.1.x-photon-scala2.12")
